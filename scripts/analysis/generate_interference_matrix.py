...
def load_metric(task_name, adapter_name):
    ...
    """
    artifacts_dir = find_repo_root(__file__) / 'artifacts'
...
def compute_weighted_merge_conflict_reduction(conflict_df, performance_matrix, output_dir):
    ...
    artifacts_root = find_repo_root(__file__) / 'artifacts'
...
def main():
    ...
    # Save to CSV
    csv_output_dir = find_repo_root(__file__) / 'analysis' / 'results'
    ...
    plot_output_dir = find_repo_root(__file__) / 'analysis' / 'plots' / 'interference'
    ...
    merge_results_dir = find_repo_root(__file__) / 'analysis' / 'results' / 'weighted'
