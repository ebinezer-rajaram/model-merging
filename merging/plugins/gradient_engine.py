    ...
    try:
        ...
        for step in step_iter:
            ...
            if should_step:
                ...
                update_ce = update_ce_sum / float(max(1, update_ce_count))
                update_ce_rolling.append(update_ce)
                ...
                monitor_ce = rolling_ce if rolling_ce is not None else update_ce
...
__all__ = ["run_gradient_optimizer", "_compute_supervised_ce_loss"]
